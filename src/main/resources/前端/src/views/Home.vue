        ...
        <el-container>
                    ...
                    <el-dropdown class="userInfo" @command="commandHandler">
                      <span class="el-dropdown-link">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item command="userinfo"><span @click="userInfo">个人中心</span></el-dropdown-item>
            ...
            <el-container>
                ...
                <el-main>
                    ...
                    <div class="homeWelcome" v-if="this.$router.currentRoute.path=='/home'">Welcome!</div>
